...
License  : MIT
Requires: pysendfile-license = %{version}-%{release}
Requires: pysendfile-python = %{version}-%{release}
Requires: pysendfile-python3 = %{version}-%{release}
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583209629
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/pysendfile
cp %{_builddir}/pysendfile-2.0.1/LICENSE %{buildroot}/usr/share/package-licenses/pysendfile/c11a3b6da42302d4843bd942eeaf0894bbedc729
...
/usr/share/package-licenses/pysendfile/c11a3b6da42302d4843bd942eeaf0894bbedc729
